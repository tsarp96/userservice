package com.tunaproject.userservice.config;
...
@Configuration
public class UsersCouchbaseConfiguration {

    private final CouchbaseProperties couchbaseProperties;

    public UsersCouchbaseConfiguration(CouchbaseProperties couchbaseProperties) {
    ...
    @Bean
    public Collection usersCollection(Cluster couchbaseCluster) {
